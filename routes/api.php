...
//     'middleware' => 'api'
// ], function () {
//     Route::post('cekuserother', [KegepawaianController::class, 'cekUserOther'])->name('cekuserother');
//     Route::post('getallpegmlg', [KegepawaianController::class, 'getAllPegMlg'])->name('getallpegmlg');
//     Route::post('getallpegskr', [KegepawaianController::class, 'getAllPegSkr'])->name('getallpegskr');
//     Route::post('autokirimjadwal', [KegepawaianController::class, 'exAutoSaveSIAPIKET'])->name('exAutoSaveSIAPIKET');
//     Route::post('kirimjadwal', [KegepawaianController::class, 'exKirimJadwal'])->name('exKirimJadwal');
// });