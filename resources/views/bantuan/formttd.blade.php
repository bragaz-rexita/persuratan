                    ...
                    <div class="col-md-8">
                        <div class="card card-widget widget-user-2">
                            <div class="widget-user-header bg-success">
                                ...
                                <h3 class="widget-user-username">Yth. {{$surat->kepada}}</h3>
                                <h5 class="widget-user-desc">Mohon Menggambarkan Tandatangan Bapak/Ibu di Kotak Yang di Sediakan</h5>
                            </div>
                        </div>
                        <div class="card card-body">
                            <iframe src="{!! $alamatweb !!}" width="100%" height="780" style="border: none;" id="document-preview"></iframe>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-danger">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="nimmhs">Surat</label>
                                    <input type="text" class="form-control" id="nimmhs" value="{{$surat->perihal}}" disabled="disable">
                                </div>
                                <div class="form-group">
                                    <label for="jurusan">Konseptor</label>
                                    <input type="text" class="form-control" id="jurusan" value="{{$surat->pembuat}}" disabled="disable">
                                </div>
                                <div class="form-group">
...
<input type="hidden" name="idsurat" id="idsurat" value="{{ $surat->id }}">
<input type="hidden" name="alamatweb" id="alamatweb" value="{{ $alamatweb }}">
    ...
    $(document).ready(function () {
        ...
        $("#btnsetuju").click(function(){
            ...
            if (val02 == '') { 
                swal({
                    title	: 'Stop',
                    text	: 'Mohon Membubuhkan Tanda Tangan Anda',
                    type	: 'warning',
                })
            } else {
        ...
        $("#btntidak").click(function(){
            ...
            if (val02 == '') { 
                swal({
                    title	: 'Stop',
                    text	: 'Mohon Membubuhkan Tanda Tangan Anda, Meskinpun anda tidak setuju',
                    type	: 'warning',
                })
            } else if (val03 == '') { 
                swal({
                    title	: 'Stop',
                    text	: 'Mohon Mengisi Alasan Anda Mengapa Tidak Setuju / Tidak Bersedia',
                    type	: 'warning',
                })
            } else {
