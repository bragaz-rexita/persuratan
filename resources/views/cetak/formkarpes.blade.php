...
<html>
	...
	<body>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-image: url('{!! $logo_grey !!}'); background-repeat: no-repeat; background-position: center;">
		  <tr>
			<td colspan="3" rowspan="7" align="center" valign="middle" style="border-bottom:double"><img src="{!! $logo !!}" width="90" /></td>
		  ...
		  <tr>
			<td colspan="8">NIS : {!! $rsetting->nis !!} – NSS : {!! $rsetting->nss !!} – NPSN : {!! $rsetting->npsn !!}</td>
		  </tr>
		  <tr>
			<td colspan="8">{!! $rsetting->alamat !!}</td>
		  </tr>
		  <tr>
			<td colspan="8">Telpon {!! $rsetting->telp !!} Email {!! $rsetting->email !!}</td>
		  </tr>
		  <tr>
		...
		@else
		<table width="800" border="0" cellpadding="0" cellspacing="0" style="background-image: url('{!! $logo_grey !!}'); background-repeat: no-repeat; background-position: center;" id="printiki">
		  <tr>
		  ...
		  <tr>
			<td colspan="6" rowspan="3" align="center" valign="middle"><img src="{!! $logokecil !!}" width="340" height="70" /></td>
