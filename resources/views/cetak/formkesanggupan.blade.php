...
<html>
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-image: url('{!! $logo_grey !!}'); background-repeat: no-repeat; background-position: center;">
		  ...
		  <tr>
			<td colspan="8" align="center">NIS : {!! $rsetting->nis !!} – NSS : {!! $rsetting->nss !!} – NPSN : {!! $rsetting->npsn !!}</td>
		  </tr>
		  <tr>
			<td colspan="8" align="center">{!! $rsetting->alamat !!}</td>
		  </tr>
		  <tr>
			<td colspan="8" align="center">Telpon {!! $rsetting->telp !!} Email {!! $rsetting->email !!}</td>
		  </tr>
		  <tr>
