        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-5" id="divsettingpejabat">
                    ...
                    <div class="card card-danger" id="divinput">
...
<script>
	...
	$('#btnsimpanpejabat').click(function () {
		...
		$('#loading').show();
		$('#divinput').hide();
		$.post('{{route("exSimpanpejabat")}}', { val01: set01, val02: set02, val03: set03, val04: set04, val05: set05, val06: set06, val07: set07, val08: set08, val09: set09, val10: set10, val11: set11, val12: set12, val13: set13, val14: set14, val15: set15, val16: set16, val17: set17, val18: set18, val19: set19, val20: set20, _token: token }, function(data){
