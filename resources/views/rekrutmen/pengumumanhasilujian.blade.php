...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h1>Pengumuman Hasil Ujian Kompetensi</h1></div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
            <li class="breadcrumb-item active">Pengumuman Hasil Ujian Kompetensi</li>
          </ol>
        </div>
      </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td width="80%">
                                <table width="800" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td colspan="8" align="left" valign="middle"><font size="+3">{!! $namaapps01 !!}</font></td>
                                        <td>&nbsp;</td>
                                        <td align="left" valign="middle">&nbsp;</td>
                                        <td rowspan="4" align="left" valign="middle"><img src="{!!$foto!!}" width="100%"/></td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" align="left" valign="middle"><font size="+2"><b>{!! $subsubdomainapps01 !!}</b></font></td>
                                        <td align="center">&nbsp;</td>
                                        <td align="center">&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="11" style="border-bottom:double" align="center"><strong>Hasil UJIAN</strong></td>
                                    </tr>
                                </table>
                            </td>
                            <td width="10%">&nbsp;</td>
