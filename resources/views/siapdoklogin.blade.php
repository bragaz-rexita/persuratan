...
<html>
   <head>
        ...
        <!-- App favicon -->
        <link rel="icon" href="@if (isset($icon01)){{ asset($icon01) }}@else{{ asset('duidev-softwarehouse.png') }}@endif">
        <link rel="apple-touch-icon" href="@if (isset($icon01)){{ asset($icon01) }}@else{{ asset('duidev-softwarehouse.png') }}@endif">
    ...
    <div class="wrapper" >      
					...
					<div class="col-md-12">
						<div class="box box-widget widget-user">
							<div class="widget-user-header bg-black" style="background-image: url('{!! config('global.mrinbackground') !!}'); background-repeat: no-repeat; background-position: center; background-position-y: 15px; height: 140px;">
							  ...
							  <a href="/"><h5 class="widget-user-desc">@if (isset($namaapps01)){{ $namaapps01 }}@else{{ config('global.Title') }}@endif</h5></a>
							</div>
							<div class="widget-user-image">
								<img class="img-circle" src="@if (isset($icon01)){{ $icon01 }}@else{{ asset('duidev-softwarehouse.png') }}@endif" alt="@if (isset($namaapps01)){{ $namaapps01 }}@else{{ config('global.Title') }}@endif">
							</div>
							<div class="box-footer">
									...
									<div class="col-lg-4 border-right">
										<div class="box box-widget widget-user">
											<div class="widget-user-header bg-red">
											  <div class="widget-user-image">
												<img class="img-circle" src="{{ asset('dist/img/lhead.png') }}" alt="Duidev Logo 01">
											  </div>
											  <h3 class="widget-user-username">Aplikasi</h3>
											  <h5 class="widget-user-desc">@if (isset($domainapps01)){{ $domainapps01 }}@else{{ config('global.swandhananama') }}@endif</h5>
											</div>
											<div class="box-footer">
												<div class="row">
													<div class="col-lg-6">
														<a href="#" class="btn btn-block btn-social btn-danger" id="btnviewlogin">
									...
									<div class="col-lg-4 border-right">
										<div class="box box-widget widget-user">
											<div class="widget-user-header bg-green">
											  <div class="widget-user-image">
												<img class="img-circle" src="{{ asset('dist/img/wasimonghead.png') }}" alt="Duidev Logo 02">
											  </div>
											  <h3 class="widget-user-username">Safehouse</h3>
											  <h5 class="widget-user-desc">Telemedicine, Covid Report System</h5>
											</div>
											<div class="box-footer">
												<div class="row">
                                                    <a href="https://siapdok.duidev.com/safehome/tamu-1663758166" class="btn btn-block btn-social btn-success">
                                                        <i class="fa fa-bank"></i> Go To Portal
                                                    </a>
												</div>
									...
									<div class="col-lg-4 border-right">
										<div class="box box-widget widget-user">
											<div class="widget-user-header bg-yellow">
											  <div class="widget-user-image">
												<img class="img-circle" src="{{ asset('dist/img/phead.png') }}" alt="Duidev Logo 03">
											  </div>
											  <h3 class="widget-user-username">Klinik Registrasi</h3>
											  <h5 class="widget-user-desc">Surat Keterangan Bebas Covid</h5>
											</div>
											<div class="box-footer">
												<a href="{{url('')}}/klinikub" class="btn btn-block btn-social btn-warning">
													<i class="fa fa-money"></i> Go To Portal
												</a>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-lg-2 border-right">
										<a href="/" class="btn btn-block btn-social btn-primary">
										...
										<div class="box box-widget">
											<div class="post">
												<div class="user-block">
													<img class="img-circle" src="@if (isset($icon01)){{ $icon01 }}@else{{ asset('duidev-softwarehouse.png') }}@endif" alt="User Image">
													<span class="username"><a href="#">@if (isset($domainapps01)){{ $domainapps01 }}@else{{ config('global.Title') }}@endif</a></span>
													<span class="description">Shared publicly - {{date('H:i')}} Today</span>
												</div>
												<h1>Selamat Datang di Aplikasi Contoh / Demo Kami</h1>
												<p>
													<ul>
													<li>Username Admin : admin</li>
													<li>Password Admin : bismillah</li>
													<li>Username Presiden : President</li>
													<li>Password Presiden : President</li>
													<li>Username Vice Presiden : vc1president</li>
													<li>Password Vice Presiden : vc1president</li>
													<li>Login Sebagai Penghuni Safehouse bisa di klik melalui link diatas langsung</li>
													<li>Login Sebagai Admin Safehouse bisa menggunakan username dan password contoh diatas dengan url login admin : <a href="https://siapdok.duidev.com/safehouse">https://siapdok.duidev.com/safehouse</a></li>
													<li>Manual book Bisa di download setelah login</li>
												</p>
											</div>
											<div class="post clearfix">
												<div class="user-block">
													<img class="img-circle img-bordered-sm" src="@if (isset($icon01)){{ $icon01 }}@else{{ asset('duidev-softwarehouse.png') }}@endif" alt="User Image">
													<span class="username"><a href="#">@if (isset($subdomainapps01)){{ $subdomainapps01 }}@else{{ config('global.Title2') }}@endif</a></span>
													<span class="description">Shared publicly - {{date('H:i')}} Today</span>
												</div>
												<p>
													@if (isset($namaapps01)){{ $namaapps01 }}@else{{ config('global.Title') }}@endif
													<br />@if (isset($domainapps01)){{ $domainapps01 }}@else{{ config('global.Title2') }}@endif
													<br />@if (isset($subdomainapps01)){{ $subdomainapps01 }}@else{{ config('global.yayasan') }}@endif
													<br />@if (isset($subsubdomainapps01)){{ $subsubdomainapps01 }}@else{{ config('global.sekolah') }}@endif
													<br />@if (isset($addressapps01)){{ $addressapps01 }}@else{{ config('global.alamat') }}@endif
													<br />@if (isset($kota01)){{ $kota01 }}@else{{ config('global.kota') }}@endif
													<br />@if (isset($emailapps01)){{ $emailapps01 }}@else{{ config('global.email') }}@endif
												</p>
											</div>
										</div>
									</section>
								...
								<div id="pendaftaranortu">
									<div class="col-md-12">
										<div class="box box-solid">
											<div class="box-header with-border">
												<h3 class="box-title">Lengkapi formulir berikut untuk mendaftar</h3>
												<div class="box-tools">
												    <button type="button" class="btn btn-box-tool btnkembalikepilihan" ><i class="fa fa-times"></i></button>
												</div>
											</div>
											...
											<div class="box-footer">
                                                <div class="social-auth-links text-center">
                                                    ...
                                                    <a id="btnsimpanpendaftaran" href="#" class="btn btn-social btn-primary btn-block">
                                ...
                                <div id="divlogin">
									<div class="col-md-12">
										<div class="box box-solid">
											...
											<div class="box-body">
                                                <form class="form-horizontal" id="formisitelemedi" action="{{ url('authenticatesiapdok') }}" method="POST">
                                                    {{ csrf_field() }}
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group">
                                                        <a id="btnlogin" href="#" class="btn btn-social btn-primary btn-block">
													...
													<div class="tab-content">
														<div class="tab-pane active" id="profile">
															<section>
                                                                ...
                                                                @if (isset($profile)){{ $profile }} @endif
															</section>
														</div>
														<div class="tab-pane" id="visimisi">
															<section>
                                                            @if (isset($visimisi)){{ $visimisi }} @endif
															</section>
														</div>
														<div class="tab-pane" id="strukturorganisasi">
															<section>
                                                            @if (isset($strukturorganisasi)){{ $strukturorganisasi }} @endif
															</section>
														</div>
														<div class="tab-pane" id="pendidik">
															<section>
                                                            @if (isset($pendidik)){{ $pendidik }} @endif
															</section>
														</div>
														<div class="tab-pane" id="jadwal">
															<section>
                                                            @if (isset($jadwal)){{ $jadwal }} @endif
															</section>
														</div>
														<div class="tab-pane" id="kontak">
															<section>
                                                            @if (isset($kontak)){{ $kontak }} @endif
															</section>
														</div>
													</div>
												</div>
									...
									<div class="col-md-12">
										<div class="box box-solid">
											...
											<div class="box-body">
												...
												<div class="form-group">
													<div id="divpreviewinfoberkala">@if (isset($pengumuman)){{ $pengumuman }} @endif</div>
													<div id="divpreviewinfosertamerta">@if (isset($sertamerta)){{ $sertamerta }} @endif</div>
													<div id="divpreviewinfosetiapsaat">@if (isset($setiapsaat)){{ $setiapsaat }} @endif</div>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="box box-solid">
											<div class="box-header with-border">
												...
												<div class="box-tools">
													<a href="{{url('')}}"><button type="button" class="btn btn-box-tool"><i class="fa fa-times"></i></button></a>
												</div>
											</div>
											<div class="box-body">
												<div class="form-row">
		...
		<footer class="main-footer">
			<div class="pull-right hidden-xs">
			  <b>@if (isset($namaapps01)){{ $namaapps01 }}@else{{ config('global.Title') }}@endif</b>
			</div>
			<strong>Copyright &copy; 2020 <a href="{{ url('') }}">@if (isset($domainapps01)){{ $domainapps01 }}@else{{ config('global.Title2') }}@endif</a>.</strong> All rights reserved.
		</footer>
    </div>
	<!-- TOKEN -->
	...
	<script>
		...
		$(document).ready(function() {
            ...
            $('#btnlogin').click(function () {
                ...
                var set04=document.getElementById('daftar_fakultas').value;
                ...
                if (set01 == ''){
                    ...
                    $.ajax({
                        ...
                        success: function(response, status, xhr) {
							...
							window.location.href = response.laman;
            ...
            $('#btnsimpanpendaftaran').click(function () {
